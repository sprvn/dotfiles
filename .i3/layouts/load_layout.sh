...
w4() {
    ...
    (gnome-terminal --role="41" --working-directory=/home/kevgus &)
    (gnome-terminal --role="42" --working-directory=/home/kevgus &)
    (gnome-terminal --role="43" --working-directory=/home/kevgus &)
    (gnome-terminal --role="44" --working-directory=/home/kevgus &)
}
w5() {
